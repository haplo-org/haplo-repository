...
P.Ingest.text({
    ...
    "status-list:returned_author": "Please add the additional informaiton requested",
    
    "transition-indicator": "primary",
    "action-label": "Progress",
    
    "transition:publish": "Publish",
    "tranistion-notes:publish": "Publish this item to the institutional repository",
    "transition-confirm:publish": "You have chosen to publish this item to the institutional repository",
    
    "transition:return": "Return",
    "tranistion-notes:return": "Return the item to the author for further information",
    "transition-confirm:return": "You have chosen to return the time to the author",
    "transition-indicator:return": "secondary",
    
    "transition:place_on_hold": "Put on hold",
    "tranistion-notes:place_on_hold": "Put the deposit process on hold",
    "transition-confirm:place_on_hold": "You have chosen to put the deposit process on hold",
    "transition-indicator:place_on_hold": "secondary",
    
    "transition:submit": "Resubmit",
    "tranistion-notes:submit": "Resubmit the item with amended information for review by repository staff",
    "transition-confirm:submit": "You have chosen to resubmit the item",
    ...
    "timeline-entry:return": "returned the item to the author",

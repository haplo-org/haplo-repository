...
The schema for this matches the @relatedIdentifier@ element from the "DataCite 4.0 schema":http://doi.org/10.5438/0012 with @relationType@ information stored in qualifiers and platform text types defined for each of the @relatedIdentifierType@ not included in other plugins already.
